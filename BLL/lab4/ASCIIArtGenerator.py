...
from SharedAccess.color_util import ColorUtil
...
class ASCIIArtGenerator:
    ...
    def get_art_size(self):
        self.width = int(self.reader_writer.read_input('Please specify the width for the ASCII art : '))
        self.height = int(self.reader_writer.read_input('Please specify the height for the ASCII art : '))
    ...
    def get_colors(self):
        ...
        for i in range(len(self.user_symbol)):
            ...
            choice = self.reader_writer.read_input(f'Choose a color for symbol {self.user_symbol[i]}: (white / grey)')
