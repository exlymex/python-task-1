...
class Menu5Lab:
    ...
    def display_options(self):
        print("Pasha ART Generator")  # Red color for title
    ...
    def run(self):
        while True:
            ...
            choice = self.validator.validate_input("Please select an option (1-6): ", ['1', '2', '3', '4', '5', '6'])
            if choice == '1':
                figure_choice = self.validator.validate_input("Which figure would you like to create, Cube or Pyramid? ", ['Cube', 'Pyramid'])
                ...
                if self.figure is None:
                    ...
                    size = self.validator.validate_input("What size should the figure be (1 or 2)? ", ['1', '2'])
